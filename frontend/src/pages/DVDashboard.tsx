  ...
  return (
    <div className="dash">
      <header className="dash__header">
        <h1><img className="dash__logo dash__logo--flat" src="/sanvest-azul.png" alt="Sanvest" />Desarrollo para la Venta · <b className="dash__proj">{project.label}</b></h1>
      ...
      <section className="row row--two">
        <div className="stack">
          ...
          <KpiCard spec={CARDS[3]}
            values={CARDS[3].fields.map((f) => aggregate(pointRows[f.table], f.col, f.agg))} />
        </div>
