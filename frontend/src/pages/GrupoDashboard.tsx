  ...
  return (
    <div className="dash">
      ...
      <section className="row" style={{ gridTemplateColumns: "1fr" }}>
        <BalanceSheet title="Balance Grupo" rows={balRows} valueFields={BAL_FIELDS} subField="N1 " orderField="Indice"
      ...
      {expand && (
        <div className="overlay">
          <div className="overlay__main">
            {expand === "balance" ? (
              <BalanceSheet title={`Balance Grupo — ${tri}`} rows={balRows} valueFields={BAL_FIELDS} subField="N1 " orderField="Indice"
                headerGroups={[{ label: tri || "Trimestre", cols: 4 }, { label: lqLabel, cols: 4 }]}
